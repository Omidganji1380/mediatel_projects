...
use App\Settings\ClientSideEnSettings as EnSettings;
use Artisan;
...
class ClientSideEnSettings extends SettingsPage
{
    protected static ?string $navigationIcon = 'heroicon-o-cog';

    protected static string $settings = EnSettings::class;

    protected static ?string $navigationGroup = 'تنظیمات';
    protected static ?string $navigationLabel = 'بخش انگلیسی کاربر';
    protected static ?string $title = 'بخش انگلیسی کاربر';
    public $seoMetaKey;
