...
class TelegramEnSettingsPage extends SettingsPage
{
    protected static ?string $navigationGroup = 'تنظیمات';
    protected static ?string $navigationIcon = 'heroicon-o-cog';
    protected static ?string $navigationLabel = 'بخش انگلیسی تلگرام';
    protected static ?string $title = 'بخش انگلیسی تلگرام';
    protected static string $settings = TelegramEnSettings::class;
    ...
    {
        Artisan::call("migrate:refresh --path=database/settings/2023_01_15_080941_reset_telegram_en_settings.php");
