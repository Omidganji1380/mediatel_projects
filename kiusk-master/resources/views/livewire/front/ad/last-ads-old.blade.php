<section class="ad-list-block m-0">
    <div class="container">
        ...
        <!-- cards -->
        <div class="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-3 p-4 p-md-0 cards">
            @forelse ($ads as $ad)
        ...
        @if ($hasPage)
            <div class="text-center ad-load-more">
                ...
                <button class="btn btn-primary btn-framed btn-rounded loadmore" wire:click="nextPageaa">
                    آگهی بیشتر...
                    <div wire:loading>
