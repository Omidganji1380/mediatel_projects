...
<div class="col-11 m-auto ">
    ...
    <form class="row g-3 position-relative">
        ...
        <div class="col-md-12">
            ...
            <input type="text" wire:model="ad.title"
                class="form-control  @error('ad.title') is-invalid @enderror" id="title">
            @error('ad.title')
                <span class=" text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="col-md-12">
            <label for="en_title" class="form-label">{{ __('Ad English Title') }}</label>
            <input type="text" wire:model="ad.title_en"
                class="form-control  @error('ad.title_en') is-invalid @enderror" id="en_title">
            @error('ad.title_en')
                <span class=" text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-12">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" wire:model="showPhone" id="gridCheck">
                <label class="form-check-label" for="gridCheck">
        ...
        <div class="form-floating">
            <textarea class="form-control @error('content') is-invalid @enderror" wire:model="content"
                placeholder="{{ __('Ad Description') }}" id="content" style="height: 200px !important"></textarea>
...
<div class="col-12 mt-5 d-flex justify-content-between">
    ...
    <button type="submit" class="btn btn-success"
        wire:click="goTo('realEstateDetails')">{{ __('Next Stage') }}
    </button>
</div>
