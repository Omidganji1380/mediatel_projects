...
<div class="container"> --}}
    ...
    <div class="messenger">
        ...
        <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
            ...
            <div class="m-header">
                <nav>
                    <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">{{ __('messages.messages') }}</span> </a>
                    {{-- header buttons --}}
            ...
            <div class="m-header m-header-messaging">
                <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <nav class="m-header-right">
                        ...
                        <a href="{{ $lang }}/my-account"><i class="fas fa-home"></i></a>
