...
<body>
    <div class="container">
        @include('front.layouts.header.email-header', ['image' => asset('images/emails/16.jpg')])
        <div class="container">
            <div class="mobile-center" style="text-align: center !important; padding-bottom: 2em;">
                ...
                {!! $message ?? __('emails.messages.unread_messages', ['count', $unreadCount]) !!}
                <a href="{{ $link ?? route('front.chat') }}"
