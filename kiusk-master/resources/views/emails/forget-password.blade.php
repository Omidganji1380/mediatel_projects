...
<body dir="{{ App::isLocale('fa') ? "rtl" : "ltr" }}">
    <div class="container">
        @include('front.layouts.header.email-header', ['image' => asset('images/emails/20.jpg')])
        <div class="container">
            <div class="mobile-center" style="text-align: center !important; padding-bottom: 2em;">
                <h1 class="text-danger"
                    ...
                    {{ __('emails.greeting', ['name' => __('User')]) }}</h1>
                {!! __('emails.messages.forgot_password')  !!}
                <h2 style="text-align: center !important;">{{ $token }}</h2>
            </div>
