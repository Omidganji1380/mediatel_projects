    ...
    <div class="container">
        ...
        <div class="container">
            <div class="mobile-center" style="text-align: center !important; padding-bottom: 2em;">
                ...
                {!! $message ?? __('emails.messages.new_property_applicant') !!}
                <a href="{{ $link ?? route('front.panel.user.ad.index') }}"
                    style="display: inline-block; background-color: #007bff; margin: 1em 1em; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 4px; font-weight: bold; text-align: center; font-size: 14px;">
                    {{ $btnText ?? __('View Ad') }}
                </a>
            </div>
