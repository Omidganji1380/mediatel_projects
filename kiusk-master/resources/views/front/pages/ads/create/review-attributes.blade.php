        ...
        @switch($attribute['type'])
            @case('Text')
                <div class="col-md-6">
                    ...
                    <input type="text" disabled wire:model="formAttributes.{{ $key }}.text" class="form-control"
                        id="name">
                </div>
            @break
            ...
            @case('Select')
                <div class="col-md-6 ">
                    ...
                    <select class="form-select @error('attribute.{{ $key }}.city_id') is-invalid @enderror"
                        wire:model="formAttributes.{{ $key }}.text" disabled aria-label="Default select example">
