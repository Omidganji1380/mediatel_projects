 ...
 */
    ...
    'canada_phone' => 'متاسفانه در حال حاضر خدمات رسانی به کشور شما را نداریم!',
    'invalid_otp' => 'کد ارسالی صحیح نمیباشد.',
    /*
 |--------------------------------------------------------------------------
 ...
 */
    ...
    'referral_code' => 'کد ارجاع پیدا نشد.',
    'content_min_lines' => 'حداقل طول متن ۳ خط می باشد. لطفا مجددا متن را ارسال نمایید. ',
    'gallery_type' => 'نوع فایل ارسالی معتبر نیست، لطفا عکس ها را با فرمت JPEG, JPG, PNG  ارسال نمایید',
    'telegram_image_count' => 'تعداد عکس ها حداکثر :count عدد باید باشد.',
    'accept_rules' => 'تا زمانیکه قوانین کیوسک را نپذیرید، قادر به ادامه فرآیند نخواهید بود.',
    'availablility_date_format' => 'تاریخ در دسترس بودن با الگو مطابقت ندارد. باید مانند مثال باشد:
2024-02-24
',
    'availablility_date_after_or_equal_today' => 'تاریخ در دسترس بودن باید تاریخ بعد یا برابر امروز باشد',
];
